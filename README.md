...
## 개요
- C# 프로그래밍 학습
- 핵심기능: 버튼 컨트롤 영역 안으로 마우스가 들어가면 버튼을 랜덤 위치로 이동, 버튼 클릭 시 점수 변경
- 화면구성: 버튼, 마우스, 확인 창

## 실행화면
- 1단계 코드의 실행 스크린샷
<img width="802" height="489" alt="스크린샷 2026-03-12 115540" src="https://github.com/user-attachments/assets/448cf047-97d0-4893-b5ad-7dac862ed18a" />
...
- 점수 구현 및 점수 계산하는 코드가 어려웠다.
- 게임을 다시 시작하게 하기 위한 것을 구현하는게 어려웠다.
